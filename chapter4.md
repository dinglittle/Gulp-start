...
2.[使用 Gulp 和 压缩 JS](/chapter2.md)

---

压缩图片文件可以降低文件大小，提高图片加载速度
...
### 二、创建 `gulpfile.js` 文件缩写代码

在对应目录创建 `gulpfile.js` 文件并写入如下代码
```
//获取 gulp 
...
//在命令行使用 gulp 启动 images 任务 和 auto 任务
...
你可以访问 [地址](https://github.com/nimojs/gulp-book/tree/master/demo/chapter4/images/) 下载示例图片
